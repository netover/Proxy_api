...
class InvalidRequestError(ProviderError):
    ...
    def __init__(self, message: str, param: str = "unknown", code: str = "invalid_request_error"):
        super().__init__(message, code=code)
        self.param = param

class RateLimitError(ProviderError):
    """Raised for rate limiting errors"""
    def __init__(self, message: str, retry_after: Optional[int] = None, code: str = "rate_limit_error"):
        super().__init__(message, code=code)
