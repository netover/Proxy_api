...
class OptimizedHTTPClient:
    ...
    def __init__(
        ...
        **kwargs # Added to accept pool_limits dict gracefully
    ):
        # Handle pool_limits dictionary if present
        if 'pool_limits' in kwargs:
            pool_limits = kwargs['pool_limits']
            max_keepalive_connections = pool_limits.get('max_keepalive_connections', max_keepalive_connections)
            max_connections = pool_limits.get('max_connections', max_connections)
            keepalive_expiry = pool_limits.get('keepalive_timeout', keepalive_expiry)
...
def get_advanced_http_client(**kwargs):
    """Factory function to create an instance of the OptimizedHTTPClient."""
    return OptimizedHTTPClient(**kwargs)
