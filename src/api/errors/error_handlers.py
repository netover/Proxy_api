...
class ErrorHandler:
    ...
    async def _log_error(self, request: Request, exc: Exception, request_id: str) -> None:
    ...
    def _create_error_response(self, exc: Exception, request_id: str) -> Dict[str, Any]:
        ...
        if isinstance(exc, InvalidRequestError):
            ...
            base_response["error"]["code"] = getattr(exc, 'code', 'invalid_request_error')
    ...
    async def handle_validation_error(self, request: Request, exc: RequestValidationError) -> JSONResponse:
        ...
        logger.warning("Validation error", request_id=request_id, validation_errors=validation_errors)
