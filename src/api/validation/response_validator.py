...
class ResponseValidator:
    ...
    def __init__(self):
        ...
        self.sensitive_fields = ['api_key', 'secret', 'password', 'token', 'key']

    async def validate_chat_completion_response(self, response: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def validate_text_completion_response(self, response: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def validate_embedding_response(self, response: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def validate_image_generation_response(self, response: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def validate_generic_response(self, response: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _validate_response_size(self, response: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if response_size > self.max_response_size:
            logger.warning(f"Response size {response_size} exceeds limit {self.max_response_size}")
            ...
            if response_size > self.max_response_size:
                logger.error(f"Response still too large after truncation: {response_size}")
                return self._create_error_response("Response too large", "Response exceeded maximum size limit")
