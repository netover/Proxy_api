...
class ModelConfigService:
    ...
    def set_model_selection(
        ...
        try:
            self._config_manager.set_model_selection(
    ...
    def update_model_selection(
        ...
        try:
            success = self._config_manager.update_model_selection(
    ...
    def bulk_set_model_selections(
        self, selections: Dict[str, str], editable: bool = True
    ) -> Dict[str, Any]:
        """
