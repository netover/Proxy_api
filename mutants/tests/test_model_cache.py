...
class TestModelCache:
    ...
    def test_set_and_get_models(self):
        ...
        models = [
            ModelInfo(id="gpt-4", object="model", created=1234567890, owned_by="openai"),
            ModelInfo(id="gpt-3.5-turbo", object="model", created=1234567890, owned_by="openai")
        ]
    ...
    def test_cache_invalidation(self):
        ...
        models = [ModelInfo(id="test-model", object="model", created=1234567890, owned_by="test")]
    ...
    def test_thread_safety(self):
        ...
        models = [ModelInfo(id=f"model-{i}", object="model", created=1234567890, owned_by="test") 
                 for i in range(100)]
...
class TestCacheManager:
    ...
    @pytest.mark.asyncio
    async def test_get_models_with_cache_hit(self, mock_discovery_service, sample_models):
    ...
    @pytest.mark.asyncio
    async def test_get_models_with_cache_miss(self, mock_discovery_service, sample_models):
    ...
    @pytest.mark.asyncio
    async def test_get_models_force_refresh(self, mock_discovery_service, sample_models):
    ...
    async def test_cache_warming_with_errors(self, mock_discovery_service):
        ...
        mock_discovery_service.discover_models.side_effect = [
            [ModelInfo(id="model1", object="model", created=1234567890, owned_by="test")],
...
class TestIntegration:
    ...
    def test_concurrent_access_patterns(self):
        ...
        models = [
            ModelInfo(id=f"model-{i}", object="model", created=1234567890, owned_by="test")
            for i in range(50)
        ]
