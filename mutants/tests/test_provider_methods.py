...
class MockProvider(BaseProvider):
    ...
    async def _mock_create_completion(self, request: Dict[str, Any]) -> Union[Dict[str, Any], AsyncGenerator]:
    ...
    async def _mock_create_text_completion(self, request: Dict[str, Any]) -> Union[Dict[str, Any], AsyncGenerator]:
        """Mock implementation that makes HTTP request."""
        response = await self.make_request(
            "POST",
...
class TestProviderMethods:
    ...
    def mock_provider(self, mock_config, mock_http_client):
        ...
        with patch('src.core.provider_factory.get_advanced_http_client', return_value=mock_http_client):
            with patch('src.core.provider_factory.config_manager') as mock_config_manager:
    ...
    @pytest.mark.asyncio
    async def test_create_completion_streaming_success(self, mock_provider, mock_http_client):
    ...
    @pytest.mark.asyncio
    async def test_create_completion_authentication_error(self, mock_provider, mock_http_client):
    ...
    @pytest.mark.asyncio
    async def test_create_completion_rate_limit_error(self, mock_provider, mock_http_client):
    ...
    @pytest.mark.asyncio
    async def test_create_completion_invalid_request_error(self, mock_provider, mock_http_client):
    ...
    @pytest.mark.asyncio
    async def test_create_completion_network_error(self, mock_provider, mock_http_client):
    ...
    @pytest.mark.asyncio
    async def test_create_completion_timeout_error(self, mock_provider, mock_http_client):
    ...
    @pytest.mark.asyncio
    async def test_create_completion_malformed_response(self, mock_provider, mock_http_client):
...
class TestTextCompletionMethods:
    ...
    def mock_provider_text(self, mock_config_text, mock_http_client_text):
        ...
        with patch('src.core.provider_factory.get_advanced_http_client', return_value=mock_http_client_text):
            with patch('src.core.provider_factory.config_manager') as mock_config_manager:
    ...
    @pytest.mark.asyncio
    async def test_create_text_completion_success(self, mock_provider_text, mock_http_client_text):
...
class TestEmbeddingsMethods:
    ...
    @pytest.fixture
    def mock_provider_embeddings(self, mock_config_embeddings, mock_http_client_embeddings):
        """Create a mock provider instance for embeddings."""
        with patch('src.core.provider_factory.get_advanced_http_client', return_value=mock_http_client_embeddings):
            with patch('src.core.provider_factory.config_manager') as mock_config_manager:
                mock_config_manager.load_config.return_value = Mock(
                    get=lambda key, default=None: {
                        'http_client': {
    ...
    @pytest.mark.asyncio
    async def test_create_embeddings_success(self, mock_provider_embeddings, mock_http_client_embeddings):
...
class TestHealthCheckMethods:
    ...
    def mock_provider_health(self, mock_config_health, mock_http_client_health):
        ...
        with patch('src.core.provider_factory.get_advanced_http_client', return_value=mock_http_client_health):
            with patch('src.core.provider_factory.config_manager') as mock_config_manager:
                mock_config_manager.load_config.return_value = {
                    'http_client': {
                        'pool_limits': {
    ...
    @pytest.mark.asyncio
    async def test_health_check_success(self, mock_provider_health, mock_http_client_health):
    ...
    @pytest.mark.asyncio
    async def test_health_check_failure(self, mock_provider_health, mock_http_client_health):
    ...
    @pytest.mark.asyncio
    async def test_health_check_cached(self, mock_provider_health, mock_http_client_health):
...
class TestModelDiscoveryMethods:
    ...
    @pytest.fixture
    def mock_provider_discovery(self, mock_config_discovery, mock_http_client_discovery):
        """Create a mock provider instance for model discovery."""
        with patch('src.core.provider_factory.get_advanced_http_client', return_value=mock_http_client_discovery):
            with patch('src.core.provider_factory.config_manager') as mock_config_manager:
                mock_config_manager.load_config.return_value = {
                    'http_client': {
                        'pool_limits': {
...
class TestErrorScenarios:
    ...
    def mock_provider_error(self, mock_config_error, mock_http_client_error):
        ...
        with patch('src.core.provider_factory.get_advanced_http_client', return_value=mock_http_client_error):
            with patch('src.core.provider_factory.config_manager') as mock_config_manager:
                mock_config_manager.load_config.return_value = {
                    'http_client': {
                        'pool_limits': {
    ...
    @pytest.mark.asyncio
    async def test_unexpected_http_status(self, mock_provider_error, mock_http_client_error):
    ...
    @pytest.mark.asyncio
    async def test_empty_response_body(self, mock_provider_error, mock_http_client_error):
    ...
    @pytest.mark.asyncio
    async def test_partial_response_data(self, mock_provider_error, mock_http_client_error):
    ...
    @pytest.mark.asyncio
    async def test_concurrent_requests_error_handling(self, mock_provider_error, mock_http_client_error):
