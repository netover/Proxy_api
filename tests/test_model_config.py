...
from src.core.model_config import ModelSelection, ModelConfigManager, model_config_manager
from src.services.model_config_service import ModelConfigService, model_config_service
...
class TestModelConfigService:
    ...
    def test_update_non_editable_selection(self):
        ...
        self.model_manager.set_model_selection("test_provider", "model1", editable=False)
