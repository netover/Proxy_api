...
class ProviderFactory:
    ...
    PROVIDER_MAPPING = {
        ...
        ProviderType.ANTHROPIC: ("proxy_core.providers.anthropic", "AnthropicProvider"),
        ProviderType.PERPLEXITY: ("proxy_core.providers.perplexity", "PerplexityProvider"),
        ProviderType.GROK: ("proxy_core.providers.grok", "GrokProvider"),
        ProviderType.BLACKBOX: ("proxy_core.providers.blackbox", "BlackboxProvider"),
        ProviderType.OPENROUTER: ("proxy_core.providers.openrouter", "OpenRouterProvider"),
