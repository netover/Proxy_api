...
async def calculate_latency_percentiles(metrics: Dict[str, Any]) -> LatencyMetrics:
...
async def calculate_throughput_by_provider(metrics: Dict[str, Any]) -> ThroughputMetrics:
